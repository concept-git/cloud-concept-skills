---
name: huawei-cloud-billing-scout-cn
...
metadata:
  language: zh-CN
  translation_of: huawei-cloud-billing-scout
  version: "2.3.9"
  openclaw:
    requires:
      bins: [hcloud]
    primaryEnv: HUAWEICLOUD_SDK_AK
    homepage: https://github.com/concept-git/cloud-concept-skills/tree/main/skills/cn/huawei-cloud-billing-scout-cn
    envVars:
