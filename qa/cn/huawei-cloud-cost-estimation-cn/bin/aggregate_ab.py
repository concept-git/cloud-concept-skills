...
ITER = ROOT / "huawei-cloud-cost-estimation-cn-workspace" / "iteration-1"
...
def main() -> int:
    ...
    out = {
        "metadata": {
            "skill_name": "huawei-cloud-cost-estimation-cn",
    ...
    lines = [
        "# huawei-cloud-cost-estimation-cn A/B (iteration-1)",
        "",
