...
Usage:
  python3 qa/huawei-cloud-cost-estimation-cn/bin/run_ab_eval.py grade-all
  python3 qa/huawei-cloud-cost-estimation-cn/bin/run_ab_eval.py aggregate
"""
...
WORKSPACE = ROOT / "huawei-cloud-cost-estimation-cn-workspace" / "iteration-1"
...
def aggregate() -> None:
    ...
    subprocess.run(
        [sys.executable, str(AGG), str(WORKSPACE), "--skill-name", "huawei-cloud-cost-estimation-cn"],
