...
SKILL_DIR="$(cd "$QA_DIR/../../../skills/cn/huawei-cloud-cost-estimation-cn" && pwd)"
...
entry = next(x for x in catalog.get("skills", []) if x.get("id") == "huawei-cloud-cost-estimation-cn")
...
printf 'OK: huawei-cloud-cost-estimation-cn validation passed\n'
