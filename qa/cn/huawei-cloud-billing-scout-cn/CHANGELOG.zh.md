# huawei-cloud-billing-scout-cn 更新日志
...
- **版本**：独立 `qa/huawei-cloud-billing-scout-cn/VERSION`（与仓库根 `VERSION` 解耦）

### 文档

- `docs/skills/huawei-cloud-billing-scout-cn.md` 版本 **2.3.8**；询价指向 cost-estimation 技能
