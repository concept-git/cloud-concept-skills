# huawei-cloud-billing-scout-cn QA
...
```bash
./qa/huawei-cloud-billing-scout-cn/validate.sh              # full gate (CI / Done)
python3 qa/huawei-cloud-billing-scout-cn/bin/gate.py fast   # deterministic only
python3 qa/huawei-cloud-billing-scout-cn/bin/gate.py style  # skillcheck + markdownlint + skill-scanner
