# huawei-cloud-billing-scout-cn Changelog
...
- **versioning**: per-skill `qa/huawei-cloud-billing-scout-cn/VERSION` (decoupled from repo root `VERSION`)

### Documentation

- `docs/skills/huawei-cloud-billing-scout-cn.md`: version **2.3.8**; point pre-order quotes to cost-estimation skill
