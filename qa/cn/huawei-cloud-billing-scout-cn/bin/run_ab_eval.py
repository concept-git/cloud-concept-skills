#!/usr/bin/env python3
"""Grade A/B eval outputs under repo-root huawei-cloud-billing-scout-cn-workspace/.

Usage:
  python3 qa/huawei-cloud-billing-scout-cn/bin/run_ab_eval.py snapshot-old-skill
  python3 qa/huawei-cloud-billing-scout-cn/bin/run_ab_eval.py init-metadata
  python3 qa/huawei-cloud-billing-scout-cn/bin/run_ab_eval.py grade-all
  python3 qa/huawei-cloud-billing-scout-cn/bin/run_ab_eval.py aggregate
"""
...
WORKSPACE = ROOT / "huawei-cloud-billing-scout-cn-workspace" / "iteration-1"
SNAP_SKILL = WORKSPACE / "skill-snapshot" / "huawei-cloud-billing-scout-cn"
CURRENT_SKILL = ROOT / "skills" / "cn" / "huawei-cloud-billing-scout-cn"
...
def snapshot_old_skill() -> None:
    prefix = "skills/cn/huawei-cloud-billing-scout-cn"
