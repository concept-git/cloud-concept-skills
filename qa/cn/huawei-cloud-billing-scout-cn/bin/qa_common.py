"""Shared offline QA utilities for huawei-cloud-billing-scout-cn."""
...
ROOT = QA_DIR.parents[2]
SKILL_DIR = ROOT / "skills/cn/huawei-cloud-billing-scout-cn"
DOC_FILE = ROOT / "docs/skills/cn/huawei-cloud-billing-scout-cn.md"
