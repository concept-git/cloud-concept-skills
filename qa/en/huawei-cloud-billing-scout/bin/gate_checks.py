...
def _check_frontmatter(frontmatter: dict, *, version: str | None = None) -> None:
    ...
    if "cloud-concept-skills/tree/main/skills/en/huawei-cloud-billing-scout" not in openclaw.get("homepage", ""):
...
def _check_catalog_entry(entry: dict | None, version: str) -> None:
    ...
    if entry.get("path") != "skills/en/huawei-cloud-billing-scout" or entry.get("qa") != "qa/en/huawei-cloud-billing-scout":
