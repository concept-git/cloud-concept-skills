...
```bash
hermes skills install concept-git/cloud-concept-skills/huawei-cloud-billing-scout -y
hermes skills install concept-git/cloud-concept-skills/huawei-cloud-cost-estimation -y
```
