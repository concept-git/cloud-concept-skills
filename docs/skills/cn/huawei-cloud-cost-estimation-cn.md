...
`huawei-cloud-cost-estimation-cn` · **Huawei Cloud Cost Estimation & Controlled Provisioning — Quote, Create, Console-Guided Unsubscribe**
...
**Version:** 3.2.4 · Changelog: [qa/huawei-cloud-cost-estimation-cn/CHANGELOG.md](../../../qa/cn/huawei-cloud-cost-estimation-cn/CHANGELOG.md) · 中文仓库说明：[README-CN.md](../../../README-CN.md)
...
```text
skills/huawei-cloud-cost-estimation-cn/
...
```text
qa/huawei-cloud-cost-estimation-cn/
...
```bash
./qa/huawei-cloud-cost-estimation-cn/validate.sh
```

## Marketplaces

- ClawHub: `huawei-cloud-cost-estimation-cn` 3.2.4; bundle license MIT-0
...
npx skills add concept-git/cloud-concept-skills \
  --skill huawei-cloud-cost-estimation-cn \
  --agent cursor \
  --copy -y
```
...
```bash
rsync -a --delete ./skills/huawei-cloud-cost-estimation-cn/ ~/.hermes/skills/huawei-cloud-cost-estimation-cn/
```
