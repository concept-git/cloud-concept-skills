...
`huawei-cloud-billing-scout-cn` · **Huawei Cloud Read-Only Billing — Spend, Charges & Reconciliation**
...
**Version:** 2.3.9 · Changelog: [qa/huawei-cloud-billing-scout-cn/CHANGELOG.md](../../../qa/cn/huawei-cloud-billing-scout-cn/CHANGELOG.md) · Pre-order pricing: [huawei-cloud-cost-estimation.md](huawei-cloud-cost-estimation.md)
...
```text
skills/huawei-cloud-billing-scout-cn/
...
Grading: `qa/huawei-cloud-billing-scout-cn/evals/llm-rubric.yml` (merged into all **24** eval cases; evals 22–24 exercise dialogue-progression discipline — "一次一问").
...
```text
qa/huawei-cloud-billing-scout-cn/
├── validate.sh
├── skillcheck.toml
├── .markdownlint.json
...
```bash
./qa/huawei-cloud-billing-scout-cn/validate.sh
python3 qa/huawei-cloud-billing-scout-cn/bin/gate.py style   # optional style-only
```
...
npx skills add concept-git/cloud-concept-skills \
  --skill huawei-cloud-billing-scout-cn \
  --agent cursor \
  --copy -y
```
...
```bash
npx skills add ./skills/huawei-cloud-billing-scout-cn \
  --skill huawei-cloud-billing-scout-cn \
  --agent cursor \
  --copy -y
```
...
- [skills.sh](https://www.skills.sh/concept-git/cloud-concept-skills/huawei-cloud-billing-scout-cn)
- [SkillsMP](https://skillsmp.com/) — repo topics `claude-skills`, `claude-code-skill`; verify with `curl "https://skillsmp.com/api/v1/skills/search?q=huawei-cloud-billing-scout-cn"`
- [ClawHub](https://clawhub.ai/) — publish from `skills/huawei-cloud-billing-scout-cn/` after `./qa/.../validate.sh`
...
clawhub skill publish "$PWD/skills/huawei-cloud-billing-scout-cn" \
  --slug huawei-cloud-billing-scout-cn \
